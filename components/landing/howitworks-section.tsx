  ...
  return (
    <section className="py-16 md:py-24">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        {/* Glow Wrapper - poświata za całym contentem */}
        <div
          ref={ref}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative inline-flex overflow-hidden rounded-full p-[2px] mb-6  duration-300">
                      ...
                      {/* Step Number Circle */}
                      <div className="relative w-20 h-20 bg-gradient-to-br bg-gray-900/90 rounded-full flex items-center justify-center backdrop-blur-xl">
